package com.nhom14.controller.order;
...
import com.nhom14.entity.ChiTietDonHangID;
...
import com.nhom14.service.INguoDungService;
...
public class MuaHangController {
	...
	public String xacNhanThanhToan(HttpServletRequest request) {
		...
		return "redirect:/muahang/xemdondathang";
