	...
	<div class="row">
		...
		<div class="col-xl-2 col-lg-2 hidden-md hiden-sm hidden-xs"
			...
			<div class="cart visible-xl visible-lg hidden-md hidden-sm hidden-xs">
				<a href="/nhom14/home/giohang" id="icon-cart"> <img src="../resources/images/icon-cart.png"
					style="padding-top: 12px;">
				</a>
				<div class="text-giohang">
					<a href="/nhom14/home/giohang" style="font-size: 16px; color: #66a182;">Giỏ
						hàng</a>
