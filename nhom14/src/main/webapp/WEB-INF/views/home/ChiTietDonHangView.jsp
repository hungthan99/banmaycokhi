											...
											<table id="cart" class="table table-hover table-condensed">
												...
												<tbody>
													<c:forEach items="${cart.getGioHang() }" var="sp">
														<form method="POST" action="/nhom14/home/dathang">
															<tr>
																<td data-th="Product">
																	<div class="row">
												...
												<tfoot>
													...
													<tr>
														<td style="text-align: left;"><a href="/nhom14/home/trangchu"
														...
														<c:if test="${cart.TongTien() == 0 }">
															<td><a href="/nhom14/home/trangchu" class="btn btn-danger btn-block">Thanh
