							...
							<div class="row">
								...
								<c:forEach items="${listSanPham}" var="sp">
									<div class="col-xl-4 clo-lg-4" style="text-align: center;">
										...
										<form action="/nhom14/home/dathang" method="POST">
											<img style="width:340px; height: 450px;" src="${sp.urlHinh}" class="img-responsive"
												style="width: 100%">
											...
											<p>
												...
												<input type="hidden" name="soLuong" value="1"> <input
													...
													href="/nhom14/home/xemthongtinsanpham?maSanPham=${sp.maSanPham}"><input
